...
&nbsp;<asp:TextBox ID="TextBox1" runat="server" Width="187px"></asp:TextBox>
        ...
        <div class="bg-light fst-italic"><center><h3>MOSTRAR DUEÑO POR OBRA</h3></center></div>
        <div><center>

             <br />
             selecciona un dueño<asp:GridView ID="GridView5" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None">
             ...
             <br />
             <asp:Button ID="Button6" runat="server" OnClick="Button6_Click" Text="mostrar dueño por obra" />
             <br />
             <br />
             ...
             <br />
             <asp:TextBox ID="TextBox9" runat="server" Width="510px"></asp:TextBox>
